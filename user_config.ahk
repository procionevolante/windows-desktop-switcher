...
CapsLock & f1::MoveCurrentWindowToDesktop(1)
CapsLock & f2::MoveCurrentWindowToDesktop(2)
CapsLock & f3::MoveCurrentWindowToDesktop(3)
CapsLock & f4::MoveCurrentWindowToDesktop(4)
CapsLock & f5::MoveCurrentWindowToDesktop(5)
CapsLock & f6::MoveCurrentWindowToDesktop(6)
CapsLock & f7::MoveCurrentWindowToDesktop(7)
CapsLock & f8::MoveCurrentWindowToDesktop(8)
CapsLock & f9::MoveCurrentWindowToDesktop(9)
